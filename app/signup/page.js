            ...
            <div className="container mx-auto">
                <div className="max-w-md mx-auto my-10">
                    <div className="text-center">
                        ...
                        <p className="text-gray-500 dark:text-gray-400">Sign up to register your account</p>
                    </div>
                    <div className="m-7">
                        <form onSubmit={handleForm}>
                            ...
                            <p className="text-sm text-center text-gray-400">Already have an account? <a href="#!" onClick={()=> router.push("/signin")} className="text-indigo-400 focus:outline-none focus:underline focus:text-indigo-500 dark:focus:border-indigo-800">Sign in</a>.</p>
                        </form>
                    </div>
                </div>
            </div>
